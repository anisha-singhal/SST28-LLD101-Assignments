...
// the actual report that does the heavy disk loading
// proxy creates this lazily only when user has access
public class RealReport implements Report {
    ...
    public RealReport(String reportId, String title, String classification) {
        ...
        // load content right away when this object is created
